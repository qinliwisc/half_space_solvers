function [x_dense,Fb_ini_dense,Phi_dense,Boundary_data_dense]= ...
    boundary(N,u,fb_ini_s, L)
...
dense_n = 100; dx = L/dense_n;
x_dense_p = dx:dx:L; x_dense_p = x_dense_p(:);
...
dense_n = 100; 
x_dense_m = dx:dx:L; x_dense_m = x_dense_m(:);
