function [C,g_c] = ConstructC_xysplit_Maxwell(fb_ini_given,Nx, Ny, Nx_po, Ny_po, u, alpha1,alpha2,alpha3,dampcoef)
...
for k=1:length(index_0)
    ...
    [g0_c_d]=BoundaryData_2d_xysplit_Maxwell...
        (fb_ini_given,index_0(k), Nx, Ny, Nx_po, Ny_po, u, alpha1,alpha2,alpha3, dampcoef);
    g0_c_d = g0_c_d(:);
...
for k=1:length(index_p)
    ...
    [gp_c_d]=BoundaryData_2d_xysplit_Maxwell...
        (fb_ini_given,index_p(k), Nx, Ny, Nx_po, Ny_po, u,alpha1,alpha2,alpha3, dampcoef);
    gp_c_d = gp_c_d(:);
